...
echo "------------------------------------------------------------------------------------- \n";
Filter::filter_by_vendor($receipt, "test-vendor-1");
echo "Here's is the result of vendor filter: ";
echo "\n";
var_dump($receipt->filtered_list);
echo "\n";
...
echo "\n";
Filter::filter_by_category($receipt, "Bombs");
var_dump($receipt->filtered_list);
echo "\n";
...
echo "Here's the result of item filter: ";
echo "\n";
Filter::filter_by_item_name($receipt, "test-item-2");
var_dump($receipt->filtered_list);
echo "\n";
